/*
 * Levenshtein.c
 * @(#) $Id: Levenshtein.c 1454 2006-01-15 17:13:21Z ajung $
 ...
 * TODO:
 *
 * - Add Jaro-Winkler distance, see:
 *   W. W. Cohen et. al.: A comparison of string distance metrics for name
 *         matching tasks,
 *         IIWeb Workshop, 2003.
 *
  ...
  *medlength = len = ml;
  ...
  for (j = 0; j < len; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      /* substract what we counted from the last character but doesn't
